...
const CLIENT_ID = 'IhMwaHHL7aezrdJEdJA1XUUwfEkFIWC00hsoNYRWuj0';
    ...
    return (
        React.createElement(Fragment, null,
            ...
            React.createElement("span", {
                ...
                React.createElement("span", null, "搜尋結果關於 ",
                    React.createElement("strong", null, "「", prevQuery, "」")),

                React.createElement("span", {
                        className: "total-results"
                    }, "找到 ",
                    React.createElement("strong", null, totalResults), " 筆相符結果")),

            query === "" && queryChanged && !failedToLoad &&
            React.createElement("h3", {
                className: "text-info type-something-info"
            }, "尚未輸入任何資料！"),


            prevQuery !== "" && totalResults === 0 &&
            React.createElement("div", {
                    className: "no-image-found-info"
                },
                React.createElement("h3", null, "找不到圖片"),
                React.createElement("span", null, "嘗試搜尋 ",
                    React.createElement("strong", null, "dogs"), " 或 ", React.createElement("strong", null, "cats"))
            ),

            !failedToLoad && React.createElement("main", null,
            ...
            failedToLoad &&
            React.createElement("div", {
                    className: "failed-info-container"
                },
                React.createElement("h1", {
                    className: "failed-text"
                }, "Failed To Load"),
                React.createElement("p", null, "檢查你的連線")),
            ...
            React.createElement("form", {
                ...
                React.createElement("div", {
                    ...
                    React.createElement("button", {
                            ...
                            disabled: inputEl.current !== undefined && inputEl.current.value.length === 0 ?
                                true : false
                        },
                        ...
                        React.createElement("span", null, "搜尋"))),

                React.createElement("div", {
                        className: "form-group g-2"
                    },
                    React.createElement("button", {
                            className: "btn search",
                ...
                React.createElement("div", {
                        className: `floating--container ${isFloatingInputActive ? "" : "hide"}`
                    },
                    React.createElement("div", {
                        ...
                        React.createElement("button", {
                            className: "btn search",
                            onClick: onQuerySearch,
                            disabled: floatingInputEl.current !== undefined &&
                            ...
                            React.createElement("button", {
                                ...
                                React.createElement("div", {
                                    ...
                                    React.createElement("svg", {
                                        ...
                                        React.createElement("path", {
                                            d: "M9.9 11.5l6.1 6.1 6.1-6.1 1.9 1.9-8 8-8-8 1.9-1.9z"
                                        })))),
                            ...
                            React.createElement("div", {
                                ...
                                React.createElement("ul", null,
                                    React.createElement("li", null,
                                        React.createElement("a", {
                                                href: `${links.download}?force=true&w=640`
                                            }, "Small ",
                                    ...
                                    React.createElement("li", null,
                                        React.createElement("a", {
                                                href: `${links.download}?force=true&w=1920`
                                            }, "Medium ",
                                    ...
                                    React.createElement("li", null,
                                        React.createElement("a", {
                                                href: `${links.download}?force=true&w=2400`
                                            }, "Large ",
                ...
                React.createElement("div", {
                    ...
                    React.createElement("div", {
                        ...
                        React.createElement("div", {
                            ...
                            React.createElement("div", {
                                    className: "image-info views--container"
                                },
                                React.createElement("div", {
                                        className: "info"
                                    },
                                ...
                                React.createElement("div", {
                                        className: "info info--value"
                                    },
                                    React.createElement("span", {
                                        className: "total-views"
                                    }, beautifyNumber(views))),

                                React.createElement("div", {
                                        className: "monthly-stats"
                                    },
                                    React.createElement("span", {
                                        className: "views-stat"
                                    }, "+", viewsLastMonth), " since last month")),

                            React.createElement("div", {
                                    className: "image-info downloads--container"
                                },
                                React.createElement("div", {
                                        className: "info"
                                    },
                                    React.createElement("div", {
                                        ...
                                        React.createElement("svg", {
                                            ...
                                            React.createElement("path", {
                                                d: "M27.5 18.08a1 1 0 0 0-1.42 0l-9.08 8.59v-23.67a1 1 0 0 0-2 0v23.67l-9.08-8.62a1 1 0 1 0-1.38 1.45l10.77 10.23a1.19 1.19 0 0 0 .15.09.54.54 0 0 0 .16.1.94.94 0 0 0 .76 0 .54.54 0 0 0 .16-.1l.15-.09 10.77-10.23a1 1 0 0 0 .04-1.42z"
                                            }))),
                                ...
                                React.createElement("div", {
                                    ...
                                    React.createElement("span", {
                                        className: "downloads-stat"
                                    }, "+", downloadsLastMonth), " ", "since last month")),

                            React.createElement("div", {
                                    className: "image-info likes--container"
                                },
                                React.createElement("div", {
                                        className: "info"
                                    },
                                ...
                                React.createElement("div", {
                                    ...
                                    }, "+", likesLastMonth), " since last month"))),
